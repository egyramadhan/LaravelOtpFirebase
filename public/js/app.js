...
window.onload = function () {
  ...
  document.getElementById("name").addEventListener("keyup", updateSignInButtonUI);
  document.getElementById("name").addEventListener("change", updateSignInButtonUI);
  ...
  document.getElementById("cancel-verify-code-button").addEventListener("click", cancelVerification); // [START appVerifier]
  ...
  window.recaptchaVerifier = new firebase.auth.RecaptchaVerifier("recaptcha-container", {
    ...
    callback: function callback(response) {
      ...
      // [START_EXCLUDE]
      updateSignInButtonUI(); // [END_EXCLUDE]
    },
...
function onSignInSubmit(e) {
  ...
  if (isCaptchaOK() && isPhoneNumberValid()) {
    ...
    firebase.auth().signInWithPhoneNumber(phoneNumber, appVerifier).then(function (confirmationResult) {
      ...
      window.confirmationResult = confirmationResult; // [START_EXCLUDE silent]

      window.signingIn = false;
      updateSignInButtonUI();
      updateVerificationCodeFormUI();
      updateVerifyCodeButtonUI();
      updateSignInFormUI(); // [END_EXCLUDE]
...
function onVerifyCodeSubmit(e) {
  ...
  if (!!getCodeFromUserInput()) {
    ...
    updateVerifyCodeButtonUI(); // [START verifyCode]

    var code = getCodeFromUserInput();
    confirmationResult.confirm(code).then(function (result) {
      // User signed in successfully.
      var user = result.user; // [START_EXCLUDE]

      window.verifyingCode = false;
      window.confirmationResult = null;
      updateVerificationCodeFormUI(); // [END_EXCLUDE]
    })["catch"](function (error) {
      ...
      window.verifyingCode = false;
      updateSignInButtonUI();
      updateVerifyCodeButtonUI(); // [END_EXCLUDE]
    }); // [END verifyCode]
  }
}
/**
...
function isCaptchaOK() {
  if (typeof grecaptcha !== "undefined" && typeof window.recaptchaWidgetId !== "undefined") {
    ...
    var recaptchaResponse = grecaptcha.getResponse(window.recaptchaWidgetId); // [END getRecaptchaResponse]
...
function updateSignInButtonUI() {
  document.getElementById("sign-in-button").disabled = !isCaptchaOK() || !isPhoneNumberValid() || !!window.signingIn;
}
/**
...
/***/ 0:
/*!********************************************************************************!*\
  !*** multi ./resources/js/app.js ./resources/app.js ./resources/sass/app.scss ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
